// Script para agregar perfumes a la base de datos
// Este script muestra todos los perfumes que se van a agregar
...
console.log("🎯 LISTA DE PERFUMES PARA AGREGAR");
console.log("==================================");
console.log(`📊 Total de perfumes: ${perfumes.length}\n`);

perfumes.forEach((perfume, index) => {
  console.log(`${index + 1}. ${perfume.name} - ${perfume.brand}`);
  console.log(`   📝 Descripción: ${perfume.description.substring(0, 80)}...`);
  console.log(`   🏷️  Categoría: ${perfume.category}`);
  console.log(`   💰 Precios: ${perfume.prices.join(', ')}`);
  console.log(`   🌸 Notas: ${perfume.notes.join(', ')}`);
  console.log(`   ⭐ Rating: ${perfume.rating}`);
  console.log(`   🏠 Homepage: ${perfume.showOnHomepage ? 'Sí' : 'No'}`);
  console.log("");
});
...
console.log("");
console.log("🚀 Para agregar estos perfumes a la base de datos:");
...
console.log("3. Ejecuta el script de inserción");
console.log("");
console.log("💡 Los perfumes ya están configurados con:");
console.log("   ✅ Descripciones únicas y detalladas");
console.log("   ✅ Categorías apropiadas (masculine/unisex)");
console.log("   ✅ Notas olfativas específicas");
console.log("   ✅ Tamaños estándar (5ml, 10ml, 15ml)");
console.log("   ✅ Precios base (que puedes actualizar)");
console.log("   ✅ Configuración de stock y homepage"); 