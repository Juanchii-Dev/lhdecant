...
async function addPerfumes() {
  console.log("🎯 Iniciando agregado de perfumes...");
  console.log(`📝 Total de perfumes a agregar: ${perfumes.length}`);
  ...
  for (const perfume of perfumes) {
    try {
      ...
      // Aquí podrías hacer una llamada al servidor para agregar el perfume
